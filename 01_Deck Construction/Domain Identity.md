Card included in a deck must abide to the **Domain Identity.**
The deck's **Domain Identity** is dictated by the domains of your [[Champion Legend]]. In the default card frame, these domains appear as symbols in the legend's upper left corner.
