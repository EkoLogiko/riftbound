...
**Keywords** can be identified by having a *colored highlight behind them*. The color of the highlight has no effect on gameplay.
...
**Keywords** can be referenced or specified by other [[Game Effect|Game Effects]].
